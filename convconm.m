function convconm(x,h)
  ...
  tau = -4:dtau:4; % Intervalo de visualización del resultado
  ti = 0; % Indice para el vector de resultados
  tvec = -3.25:.1:3.75; % traslaciones de t, cuantas integrales se calulan  
  ...
  for t = tvec, % Cantidad de traslaciones
      ...
      axis ([tau(1) tau(end) -4.0 4]); % límites de los ejes
      ...
      axis ([tau(1) tau(end) -4.0 2.0]); % límites del eje
      grid; % malla
